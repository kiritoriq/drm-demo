...
namespace Domain\Task\Actions\QcProgress;
        ...
        ResolveExternalUserIdsAction::resolve()
            ...
            ->execute(
                data: new CreateNotificationData(
                    title: __(key: 'notification.contractor.task.qc_progress.title'),
                    content: __(
                        key: 'notification.contractor.task.qc_progress.content',
                        replace:[
