...
namespace Domain\Ticket\Actions\Quotation\Notification\Rejected;
    ...
    public function execute(Ticket $ticket): void
    {
        ...
        foreach ($recipients as $user) {
            if (! in_array ($user->id, $sentId)) {
                $user->notify(
                    Notification::make()
                        ->title(__('notification.web.quotation.rejected.title'))
                        ->body(__('notification.web.quotation.rejected.content', [
