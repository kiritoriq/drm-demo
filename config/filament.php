...
use App\Filament\Widgets\MonthlyProjectsChart;
use App\Filament\Widgets\CustomerTicketOverview;
use App\Filament\Widgets\TaskLists;
use App\Filament\Widgets\TicketByStatusChart;
use App\Filament\Widgets\TicketQuotationsOverview;
use App\Filament\Widgets\TicketsOverview;
use App\Filament\Widgets\TicketStatusByAssigneeChart;
use App\Filament\Widgets\TicketStatusByBranchChart;
use App\Filament\Widgets\TotalTicketsChart;
...
return [
    ...
    */
    ...
    'widgets' => [
        ...
        'register' => [
            CustomerTicketOverview::class,
            TicketsOverview::class,
            TicketQuotationsOverview::class,
            TicketByStatusChart::class,
            TicketStatusByBranchChart::class,
            TicketStatusByAssigneeChart::class,
            MonthlyProjectsChart::class,
            TotalTicketsChart::class,
            TaskLists::class
        ],
    ],
